...
// --------------Selectores del form ----------------------------------------------------n---------
// cuando son multiples selectores se recomienda usar export antes de iniciarla 
...
export const formularioInput = document.querySelector('#formulario-cita');
export const formulario = document.querySelector('#formulario-cita input[type= "submit"');
